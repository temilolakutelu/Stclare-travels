...
<!-- Mirrored from demo.gridgum.com/templates/Travel-agency/left-post.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 19 Nov 2018 15:31:31 GMT -->

<head>
  <title>Left Post page - Travel agency bootstrap template</title>
  <meta charset="utf-8">
...
<body class="not-front page-post">
  ...
  <div id="main">
              ...
              <ul class="nav navbar-nav sf-menu clearfix">
                <li class="sub-menu sub-menu-1"><a href="#">Home<em></em></a>
                  <ul>
                    ...
                    <li><a href="https://demo.gridgum.com/templates/Travel-agency/index-2.php">Home Version 2
                        (slideshow)</a></li>
                ...
                <li class="sub-menu sub-menu-1"><a href="#">Pages<em></em></a>
                  <ul>
                    <li><a href="https://demo.gridgum.com/templates/Travel-agency/flights.php">Flights</a>
                      <ul>
                        <li><a href="https://demo.gridgum.com/templates/Travel-agency/search-flights.php">Search
                            Flights</a></li>
                        <li><a href="https://demo.gridgum.com/templates/Travel-agency/booking-flights.php">Booking
                            Flights</a></li>
                        <li><a href="https://demo.gridgum.com/templates/Travel-agency/booking-flights-page.php">Flights
                            Checkout</a></li>
                      </ul>
                    </li>
                    ...
                    <li><a href="https://demo.gridgum.com/templates/Travel-agency/hotels.php">Hotels</a>
                      <ul>
                        ...
                        <li><a href="https://demo.gridgum.com/templates/Travel-agency/booking-hotel-page.php">Hotel
                            Reservation</a></li>
                      </ul>
                    </li>
                    ...
                    <li><a href="https://demo.gridgum.com/templates/Travel-agency/cars.php">Rent a Car</a>
                      <ul>
                        ...
                        <li><a href="https://demo.gridgum.com/templates/Travel-agency/booking-cars-page.php">Car
                            Reservation</a></li>
                      </ul>
                    </li>
                    <li><a href="https://demo.gridgum.com/templates/Travel-agency/cruises.php">Cruises</a>
                      <ul>
                        ...
                        <li><a href="https://demo.gridgum.com/templates/Travel-agency/booking-cruise.php">Booking
                            Cruise</a></li>
                        <li><a href="https://demo.gridgum.com/templates/Travel-agency/booking-cruise-page.php">Cruise
                            Checkout</a></li>
                      </ul>
                    </li>
                  </ul>
                ...
                <li class="sub-menu sub-menu-1 active"><a href="#">Blog<em></em></a>
                  <ul>
    ...
    <div class="breadcrumbs1_wrapper">
      <div class="container">
        <div class="breadcrumbs1"><a href="https://demo.gridgum.com/templates/Travel-agency/index.php">Home</a><span>/</span>Post</div>
      </div>
    </div>
              ...
              <div class="post post-full">
                          ...
                          <div class="carousel main">
                            <ul>
                              <li>
                                <div class="sl1">
                                  <div class="sl1_inner">
                                    <img src="https://demo.gridgum.com/templates/Travel-agency/images/sl01.jpg" alt=""
                              ...
                              <li>
                                <div class="sl1">
                                  <div class="sl1_inner">
                                    <img src="https://demo.gridgum.com/templates/Travel-agency/images/sl02.jpg" alt=""
                                      class="img-responsive">
                                  </div>
                                </div>
                              </li>
                              <li>
                                <div class="sl1">
                                  <div class="sl1_inner">
                                    <img src="https://demo.gridgum.com/templates/Travel-agency/images/sl03.jpg" alt=""
                                      class="img-responsive">
                                  </div>
                                </div>
                              </li>
                ...
                <div class="post-story">
                  ...
                  <div class="post-story-info">
                    ...
                    <div class="by">Posted by <a href="#">George Smith</a> / <a href="#">26</a> Comments</div>
                  </div>
                  ...
                  <div class="post-story-body clearfix">
                    ...
                    <p>
                      ...
                      videntur parum clari, fiant sollemnes in futurum. Nam liber tempor cum soluta nobis eleifend
                      ...
                      decima et quinta decima. Eodem modo typi, qui nunc nobis videntur parum clari, fiant sollemnes in
                      futurum.
                    </p>
                    <p>
                      Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt
                  ...
                  <div class="post-story-tags clearfix">
                    ...
                    <div class="tags_wrapper"><b>Tags</b>: <a href="#">Travel</a>, <a href="#">Flights</a>, <a href="#">Early
                        ...
                        <div class="col-sm-4">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="inputEmail" name="email" value="E-mail address"
                              onBlur="if(this.value=='') this.value='E-mail address'" onFocus="if(this.value =='E-mail address' ) this.value=''">
                          </div>
                        </div>
                        <div class="col-sm-4">
                          <div class="form-group">
                            <label for="inputEmail">Website</label>
                            <input type="text" class="form-control" id="inputEmail" name="email" value="Website" onBlur="if(this.value=='') this.value='Website'"
          ...
          <div class="col-sm-3">
            <div class="blog_sidebar">
              ...
              <div class="search-form-wrapper clearfix">
                <form class="clearfix">
                  <input type="text" class="form-control" placeholder="" value="Search" onBlur="if(this.value=='') this.value='Search'"
              ...
              <div class="tabs3">
                ...
                <div class="tabs3_content">
                  <div id="tabs3-1">
                    ...
                    <div class="news1">
                      <a href="#">
                        <div class="txt1">Lorem ipsum dolor sit amet, consectetuer adipiscing elit</div>
                        <div class="txt2">Date: <span>09 June, 2016</span></div>
                      </a>
                    </div>
                    <div class="news1">
                      <a href="#">
                        <div class="txt1">Diam nonummy nibh euismod tincidunt ut laoreet dolore magna</div>
                        <div class="txt2">Date: <span>22 June, 2016</span></div>
                      </a>
                    </div>
                    <div class="news1">
                      <a href="#">
                        <div class="txt1">Lorem ipsum dolor sit amet, consectetuer adipiscing elit</div>
                        <div class="txt2">Date: <span>03 June, 2016</span></div>
                      </a>
                    </div>
                  ...
                  <div id="tabs3-2">
                    ...
                    <div class="news1">
                      <a href="#">
                        <div class="txt1">Diam nonummy nibh euismod tincidunt ut laoreet dolore magna</div>
                        <div class="txt2">Date: <span>11 June, 2016</span></div>
                      </a>
                    </div>
                    <div class="news1">
                      <a href="#">
                        <div class="txt1">Lorem ipsum dolor sit amet, consectetuer adipiscing elit</div>
                        <div class="txt2">Date: <span>25 June, 2016</span></div>
                      </a>
                    </div>
                    <div class="news1">
                      <a href="#">
      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-3">
            ...
            <p>
              Nam liber tempor cum soluta nobis option congue nihil imperdiet doming id quod mazim. Lorem ipsum dolor
          ...
          <div class="col-sm-3">
            ...
            <div class="twits1">
              ...
              <div class="twit1">
                <a href="#">@leo</a> Nam liber tempor cum soluta nobis option congue nihil imperdiet doming id quod
                mazim.
            ...
            <div class="newsletter_block">
              ...
              <div class="newsletter-wrapper clearfix">
                <form class="newsletter" action="javascript:;">
                  <input type="text" name="s" value='Email Address' onBlur="if(this.value=='') this.value='Email Address'"
      ...
      <div class="container">
        <div class="left_side">
          Copyright © 2017 <a href="#" target="_blank"><strong>MECOVACHE</strong></a> <span>|</span> <a href="#">Privacy
            Policy</a> <span>|</span> <a href="#">About Us</a> <span>|</span> <a href="#">FAQ</a> <span>|</span> <a
